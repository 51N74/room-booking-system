...
export default function AdminRegister() {
  const [formData, setFormData] = useState({
    ...
    password: "",
    confirmPassword: "",
    adminCode: "", // Optional admin registration code
  })
  ...
  return (
    <Layout title="Admin Registration - Room Booking System">
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mb-6 text-center">Register as Admin</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-gray-700 mb-2" htmlFor="adminCode">
              Admin Code (Optional)
            </label>
            <input
              type="text"
              ...
              placeholder="Enter admin code if required"
            />
          </div>
